...
var Box = styled.div(_templateObject(), space, color, layout);
...
var Flex = styled.div(_templateObject$1(), color, space, layout, flexbox);
...
var Text = styled.div(_templateObject$2(), color, typography);
...
var Avatar = function Avatar(_ref) {
  ...
  if (size === "md") {
    return React.createElement(Wrapper, null, image ? React.createElement(MediumAvatar, {
      active: active,
      as: "img",
      src: image
    }) : React.createElement(MediumAvatar, {
      active: active,
      color: color
    }), title ? React.createElement(HoverContainer, null, React.createElement(Triangle, null), React.createElement(Rectangle, null, title)) : "");
  } else if (size === "mm") {
    return React.createElement(Wrapper, null, image ? React.createElement(MmAvatar, {
      active: active,
      as: "img",
      src: image
    }) : React.createElement(MmAvatar, {
      active: active,
      color: color
    }), title ? React.createElement(HoverContainer, null, React.createElement(Triangle, null), React.createElement(Rectangle, null, title)) : "");
  } else {
    return React.createElement(Wrapper, null, image ? React.createElement(SmallAvatar, {
      active: active,
      as: "img",
      src: image
    }) : React.createElement(SmallAvatar, {
      active: active,
      color: color
    }), title ? React.createElement(HoverContainer, null, React.createElement(Triangle, null), React.createElement(Rectangle, null, title)) : "");
  }
...
var OvalButton = function OvalButton(_ref2) {
  ...
  return React.createElement(SwitchButton, {
    onClick: onClick
  }, IconWidth || IconHeight ? React.createElement(Icon, {
    width: IconWidth,
    height: IconHeight
  }) : React.createElement(Icon, null));
};

export { Avatar, BoxComponent as Box, FlexComponent as Flex, IconComponent as Icon, Input, Button as LoginButton, OvalButton, TextComponent as Text };
